...
/**
 * Copied from
 * https://github.com/keycloak/keycloak/blob/26.4.7/authz/client/src/main/java/org/keycloak/authorization/client/SystemPropertiesJsonParserFactory.java
 * since moved to another package and no more accessible.
 * <p>
